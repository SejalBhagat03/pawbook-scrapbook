...
//#region node_modules/.nitro/vite/services/ssr/assets/pawbook-data-CqSvBvet.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var coco_default = "/assets/coco-CS_7zWtf.jpg";
var moti_default = "/assets/moti-FaO6bn5l.jpg";
var kitty_default = "/assets/kitty-CubrWrHM.jpg";
var tommy_default = "/assets/tommy-DkEYBPfi.jpg";
var post_moti_default = "/assets/post-moti-BxEgHHgh.jpg";
var post_kitty_default = "/assets/post-kitty-DjfT_IVd.jpg";
var defaultAnimals = [
	{
		slug: "coco",
		name: "Coco",
		...
		healthRecords: [{
			type: "Vaccination",
			date: "12 Jan 2026",
			note: "Annual 7-in-1 vaccine completed."
		}, {
			type: "Checkup",
			date: "20 Feb 2026",
		...
		dailyThought: "Today my friends visited again. The birthday treats were nice, but the belly rubs were better ❤️",
		careTimeline: [
			{
				date: "April 2019",
				label: "🐾 First Met",
	...
	},
	{
		...
		healthRecords: [{
			type: "Vaccination",
			date: "05 Jan 2026",
			note: "Rabies booster completed."
		}, {
			type: "Checkup",
			date: "10 Mar 2026",
			note: "Deworming pill administered. Weight stable."
		}],
		friendliness: 95,
		energy: 60,
		trust: 90,
		...
		dailyThought: "The tea shop bench was warm today. A nice student scratched my ears for five whole minutes. Success! 🐶",
		careTimeline: [{
			date: "March 2025",
			label: "🐶 Met Moti",
	...
	},
	{
		...
		healthRecords: [{
			...
			type: "Vaccination",
			date: "15 Dec 2025",
			note: "Feline distemper vaccine given."
		}],
		friendliness: 50,
		energy: 40,
		trust: 85,
		...
		dailyThought: "The humans made too much noise in the reading room. I glared at them until they looked ashamed. 🐈‍⬛",
		careTimeline: [{
			date: "Feb 2025",
			label: "🐈 Library Ghost",
	...
	},
	{
		...
		dailyThought: "A yellow leaf floated down the river. I tried to catch it and got my paws all wet. Totally worth it! 🍂🐾",
		careTimeline: [{
			date: "May 2025",
			label: "🐾 Tiny Puppy",
...
var defaultMemories = [
	...
	},
	{
		...
		story: "My human made me a huge birthday cake covered in delicious treats. I ate the whole thing! 🎂🎉",
		image: coco_default,
		date: "April 4, 2026",
...
var defaultDialogues = [
	{
		petSlug: "coco",
		message: "Hey human! Did you bring birthday cookies? 👀 I might look big like a tiger but I love hugs!",
		emotion: "funny"
	},
	{
		petSlug: "coco",
	...
	{
		petSlug: "kitty",
		message: "I have selected you as my servant today. 😼 Ask me something, or just stand there in awe.",
		emotion: "attitude"
	},
	{
		petSlug: "tommy",
...
var defaultQuizQuestions = [
	{
		...
		options: [
			{
				text: "Take a deep 14-hour nap 😴",
				pet: "coco",
				icon: "😴"
			},
			{
				text: "Hunt for tasty snacks 🍪",
				pet: "coco",
				icon: "🍪"
			},
			{
				text: "Demand attention & belly rubs ❤️",
				pet: "moti",
				icon: "❤️"
			},
			{
				text: "Go on a running adventure 🏃",
				pet: "tommy",
				icon: "🏃"
			}
		]
	},
	{
		...
		options: [
			...
			{
				text: "Melting hearts with puppy eyes 🥺",
				pet: "moti",
				icon: "🥺"
			},
			{
				text: "Silent contemplation from rooftops 🐈",
				pet: "kitty",
				icon: "🐈"
			},
			{
				text: "Monsoon splash-running champ 🧣",
				pet: "tommy",
				icon: "🧣"
			}
		]
	},
	{
		...
		options: [
			{
				text: "Sunny garden walks under tree shade ☀️",
				pet: "coco",
				icon: "🌳"
			},
			{
				text: "Cozy rainy noise under a shop roof 🌧️",
				pet: "moti",
				icon: "🌧️"
			},
			{
				text: "A bright hot sunbeam on a balcony ☀️",
				pet: "kitty",
				icon: "☀️"
			},
			{
				text: "Monsoon puddles to leap over! ⛈️",
				pet: "tommy",
				icon: "⛈️"
			}
		]
	},
	{
		...
		options: [
			{
				text: "Family members with giant birthday treats 🎂",
				pet: "coco",
				icon: "🎂"
			},
			{
				text: "Tea shop owners with warm milk 🥛",
				pet: "moti",
				icon: "🥛"
			},
			{
				text: "Silence and a plate of grilled fish 🐟",
				pet: "kitty",
				icon: "🐟"
			},
			{
				text: "Anyone who has a treat in their hand! 🍖",
				pet: "tommy",
				icon: "🍖"
			}
		]
	},
	{
		...
		options: [
			{
				text: "Trot over happily looking like a tiger to get pets 🐯",
				pet: "coco",
				icon: "🐯"
			},
			{
				text: "Trot over immediately for side scratches 🐶",
				pet: "moti",
				icon: "🐶"
			},
			{
				text: "Watch them silently to judge their character 🐈",
				pet: "kitty",
				icon: "🐈"
			},
			{
				text: "Bark happily and run around their legs! 🐾",
				pet: "tommy",
				icon: "🐾"
			}
		]
...
var defaultSpinRewards = [
	{
		label: "Coco's Secret",
		color: "#F28C28",
		icon: "🍪",
		title: "Coco's Secret Garden Spot 🌳",
		content: "Coco has a secret spot in the garden where he buries his favorite bones and tiger-stripe toys!"
	},
	{
		label: "Kitty's Story",
		color: "#6495ED",
		...
		content: "Kitty has trained the tea shop owner to pour milk at exactly 4:00 PM. If they are late by 5 minutes, she sits on their keyboard!"
	},
	{
		label: "Moti's Love",
		color: "#FF6F61",
		...
		content: "Moti has a favorite student who wears a yellow scarf. Whenever they arrive, Moti runs and drops his tennis ball directly on their lap."
	},
	{
		label: "Tommy's Play",
		color: "#77DD77",
		...
		content: "Tommy holds the official village speed record of catching 12 leaves mid-air in under 3 minutes during autumn winds!"
	},
	{
		label: "Rare Memory",
		color: "#FDFD96",
		...
		content: "A student once snapped a photo of all 4 pets sleeping in a neat row under the tea stall during a monsoon storm. Total peace!"
	}
];
var defaultSurprises = [
	{
		title: "Coco's Secret 🤫",
		icon: "🍪",
		content: "Coco once saw a butterfly, got so excited he sprinted around the yard, and ended up wearing a flower pot like a hat!"
	},
	{
		title: "Moti's Cozy Memory ❤️",
		icon: "🐶",
		content: "Moti loves sitting directly on students' backpacks when they lay them on the grass, successfully preventing them from going to class."
	},
	{
		title: "Kitty's Royal Judgment 😼",
		icon: "🐈",
		content: "Kitty once spent three solid hours silently glaring at a pigeon that landed on her balcony, until the pigeon flew away in shame."
	},
	{
		title: "Tommy's Adventure 🧣",
		icon: "🐕",
		content: "Tommy chased a dry mango leaf for three entire blocks, caught it, and proudly carried it in his mouth like a golden trophy."
	},
	{
		title: "Village Secret 🗺️",
		icon: "☕",
		content: "During heavy rains, all four pets shelter under the same tea stall roof. Kitty gets the dry chair, while the dogs share the mat!"
	},
	{
		title: "Cute Pet Fact 🐾",
		icon: "✨",
		content: "Dogs can understand up to 150 words! Coco definitely knows the word 'Treat' in three different languages."
	}
];
var animals = [...defaultAnimals];
var memories = [...defaultMemories];
var dialogues = [...defaultDialogues];
var quizQuestions = [...defaultQuizQuestions];
var spinRewards = [...defaultSpinRewards];
var surprises = [...defaultSurprises];
if (typeof window !== "undefined") {
	...
	const syncCMS = async () => {
		try {
			const { data, error } = await supabase.from("cms_data").select("*").eq("id", "main").maybeSingle();
			if (error) throw error;
			if (data) {
				const fetchedAnimals = data.animals || defaultAnimals;
				if (fetchedAnimals.some((a) => a.slug === "bruno")) {
					console.log("Outdated database seed (Bruno) found. Overwriting Supabase database with Coco seed...");
					try {
						await supabase.from("cms_data").update({
							animals: defaultAnimals,
							memories: defaultMemories,
							dialogues: defaultDialogues,
						...
						console.warn("Could not update Supabase database. Falling back to local cache override.", dbErr);
					}
					animals = defaultAnimals;
					memories = defaultMemories;
					dialogues = defaultDialogues;
					...
					memories = data.memories || defaultMemories;
					dialogues = data.dialogues || defaultDialogues;
					quizQuestions = data.quiz_questions || defaultQuizQuestions;
					spinRewards = data.spin_rewards || defaultSpinRewards;
					surprises = data.surprises || defaultSurprises;
				}
				...
				if (insertError) console.warn("Could not seed default database rows (are you logged in as admin?):", insertError);
				animals = animalsPayload;
				memories = memoriesPayload;
				dialogues = dialoguesPayload;
...
var getAnimal = (slug) => animals.find((a) => a.slug === slug);
var updateCMSData = async (fields) => {
	...
	if (typeof window !== "undefined") window.dispatchEvent(new Event("pawbook-cms-refreshed"));
};
var mapPlaces = [
	{
		id: "garden",
...
//#endregion
export { mapPlaces as a, spinRewards as c, useCMS as d, getAnimal as i, surprises as l, coco_default as n, memories as o, dialogues as r, quizQuestions as s, animals as t, updateCMSData as u };
